"""
Standalone testing base classes for Netbox Physical Infra Plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "netbox_physical_infra_plugin.add_physicalinfra"
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:netbox_physical_infra_plugin:physicalinfra")
        """
