"""
Utility functions for testing Netbox Physical Infra Plugin.
...
def create_test_user(username: str | None = None, permissions: list[str | None] = None,
    ...
    Example:
        ...
        ...     permissions=['netbox_physical_infra_plugin.view_physicalinfra']
        ... )
    """
    if username is None:
...
def post_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        ...
        >>> obj = Physicalinfra.objects.first()
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Physicalinfra.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Physicalinfra': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Physicalinfra.objects.create(name='Test')
