...
### Release Summary
Initial release of Netbox Physical Infra Plugin. This is a **minor** release introducing basic functionality for managing physical-infra resources in NetBox.

### Added
- Initial plugin structure with Physicalinfra model
